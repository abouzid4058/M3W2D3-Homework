...
// Set tiles variable for use throughout the code
...
// Timer Function -> starts timer when game is started and stops when the game is over or canceled
let count;

const startTimer = () => {
    clearInterval(timer); // Clears timer before timer starts to prevent multiple intervals
    count = 0;
    timer = setInterval(() => {
        count++;
...
const displayTile = (e) => {
    // Reveal tile by changing background color and font-size
